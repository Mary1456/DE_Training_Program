...
def process_customers_to_silver(spark, bronze_base_path, silver_base_path, processing_date_str):
    ...
    try:
        ...
        # Split 'name' column into first_name and last_name (if last_name missing, put empty string)
        ...
        # Lowercase and trim email, convert signup_date to date (assuming signup_date column exists)
        ...
        # Fill missing email and signup_date
        df_customers_cleaned = df_customers_cleaned.fillna({
            "email": "unknown@example.com",
            "signup_date": "2000-01-01"
        })

        # Select and cast columns for Silver schema
        df_customers_silver = df_customers_cleaned.select(
            ...
            # Add more columns here if you have in Bronze
        )
